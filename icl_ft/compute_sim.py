...
base_dir = "/content/drive/MyDrive/Colab-Notebooks/INF502_JAN2023_A1/LMOps/understand_icl/ana_rlt"
...
if not os.path.exists(os.path.join(base_dir, 'rlt_json')):os.makedirs(os.path.join(base_dir, 'rlt_json'))
